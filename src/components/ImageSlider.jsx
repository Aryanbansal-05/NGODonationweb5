...
const ImageSlider = ({ images = [], interval = 5000 }) => {
  ...
  return (
    <div className="relative w-full max-w-8xl mx-auto overflow-hidden rounded-lg shadow-lg ">
      <div className="absolute inset-0 z-20 flex flex-col items-start  px-10 md:px-10 text-white mt-[500px] ">
        <h1 className="text-5xl md:text-8xl font-extrabold drop-shadow-[0_4px_4px_rgba(0,0,0,0.7)] leading-tight">
